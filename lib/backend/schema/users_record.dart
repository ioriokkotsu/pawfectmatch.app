...
class UsersRecord extends FirestoreRecord {
  ...
  // "petsFavorite" field.
  List<DocumentReference>? _petsFavorite;
  List<DocumentReference> get petsFavorite => _petsFavorite ?? const [];
  bool hasPetsFavorite() => _petsFavorite != null;
  ...
  void _initializeFields() {
    ...
    _petsFavorite = getDataList(snapshotData['petsFavorite']);
...
class UsersRecordDocumentEquality implements Equality<UsersRecord> {
  ...
  bool equals(UsersRecord? e1, UsersRecord? e2) {
    ...
    return e1?.email == e2?.email &&
        ...
        e1?.gender == e2?.gender &&
        e1?.bio == e2?.bio &&
        listEquality.equals(e1?.petsFavorite, e2?.petsFavorite) &&
