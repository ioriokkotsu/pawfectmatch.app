          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('EDIT_PROFILE_arrow_back_ios_ICN_ON_TAP');
                                  ...
                                  child: Padding(
                                    ...
                                    child: AuthUserStreamWidget(
                                      builder: (context) => InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'EDIT_PROFILE_Container_0zlw6ru3_ON_TAP');
                                          logFirebaseEvent(
                                          ...
                                          _model.apiResultDP =
                                              await CloudinaryPOSTCall.call(
                                            file: _model.uploadedLocalFile,
                                          );

                                          if (!(_model.apiResultDP?.succeeded ??
                                              true)) {
                                            logFirebaseEvent(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              await currentUserReference!
                                ...
                                photoUrl: CloudinaryPOSTCall.imageUploadedUrl(
                                  (_model.apiResultDP?.jsonBody ?? ''),
                                ),
                              ));
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                    'Greats, your profile had been updated!',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Inter',
