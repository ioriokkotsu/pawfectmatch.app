...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFFD7DB);
  late Color secondary = const Color(0xFF624E47);
  late Color tertiary = const Color(0xFFE4D294);
  late Color alternate = const Color(0xFFDBA9AF);
  late Color primaryText = const Color(0xFF332823);
  ...
  late Color rejected = Color(0xFFEC1212);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF624E47);
  late Color secondary = const Color(0xFFFFD7DB);
  late Color tertiary = const Color(0xFFE4D294);
  late Color alternate = const Color(0xFFDBA9AF);
  late Color primaryText = const Color(0xFFF8EAEC);
  ...
  late Color rejected = Color(0xFF880BD3);
}
